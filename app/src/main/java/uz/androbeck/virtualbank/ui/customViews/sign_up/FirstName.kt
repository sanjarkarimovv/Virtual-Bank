...
class FirstName @JvmOverloads constructor(
    context: Context,
    ...
    init {
        LayoutInflater.from(context).inflate(R.layout.first_name, this, true)

        textInputLayout = findViewById(R.id.first_name_layout)
        textInputEditText = findViewById(R.id.first_name_edit_text)
